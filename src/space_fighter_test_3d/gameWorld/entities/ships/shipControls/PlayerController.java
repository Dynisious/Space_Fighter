        ...
        if (getShip() != null) {
            ...
            synchronized (getShip().valuesLock) {
                if ((e.getKeyCode() == (Integer) keys[0][0]) && (Boolean) keys[0][1]) {
                    keys[0][1] = false;
                    getShip().getLinearForcesIncrement().z += getShip()
                            .getMaxLinearForcesIncrement().z;
                    ...
                    keys[2][1] = false;
                    getShip().getLinearForcesIncrement().x -= getShip()
                            .getMaxLinearForcesIncrement().x;
                    ...
                    keys[4][1] = false;
                    getShip().getLinearForcesIncrement().y += getShip()
                            .getMaxLinearForcesIncrement().y;
                    ...
                    keys[6][1] = false;
                    getShip().getTorquesIncrement().y += getShip()
                            .getMaxTorquesIncrement().y;
                    ...
                    keys[8][1] = false;
                    getShip().getTorquesIncrement().x -= getShip()
                            .getMaxTorquesIncrement().x;
                    ...
                    keys[10][1] = false;
                    getShip().getTorquesIncrement().z += getShip()
                            .getMaxTorquesIncrement().z;
